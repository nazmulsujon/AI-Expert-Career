...
const Navbar = () => {
    ...
    <>
      <li>
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isActive
              ? 'relative after:absolute after:bg-[#ED1B24] after:text-white after:w-[20px] after:h-[5px] after:rounded after:right-0 after:mx-auto after:left-0 after:bottom-[-8px] text-[#ED1B24] px-3 py-2 hover:text-[#ED1B24] duration-150'
              : isPending
              ? 'pending'
      ...
      <li className="swc">
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isActive
              ? 'relative after:absolute  after:text-white after:w-[20px] after:h-[5px] after:rounded after:right-0 after:mx-auto after:left-0 after:bottom-[-8px] px-3 py-2 hover:text-[#ED1B24] duration-150'
              : isPending
              ? 'pending'
              : 'px-3 hover:text-[#ED1B24] duration-150'
          }
        >
          <div className="dropdown inline-block relative">
            ...
            <ul className="dropdown-menu absolute w-[200px] z-40  bg-[#282c30] text-gray-700 pt-1">
              <li className="">
                <Link
                  className="hover:bg-[#1a1e27] duration-150 text-white py-2 px-4 block whitespace-no-wrap"
                  to="/kit"
                >
                  AI Too & Kit
                </Link>
    ...
    <li>
      ...
      <li className="">
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isActive
              ? 'relative after:absolute  after:text-white after:w-[20px] after:h-[5px] after:rounded after:right-0 after:mx-auto after:left-0 after:bottom-[-8px]  px-3 py-2 '
              : isPending
                ? 'pending'
                : 'px-3'
          }
        >
          <div className="dropdown inline-block relative">
            ...
            <ul className="dropdown-menu-2  absolute z-40 w-[200px] bg-[#282c30] text-gray-700 pt-1">
              <li className="">
                <Link
                  className="rounded-t hover:bg-[#1a1e27] duration-150 text-white py-2 px-4 block whitespace-no-wrap"
                  to="/roadmap"
                >
                  AI Roadmap
                </Link>
      ...
      <li className="mr-3">
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isActive
              ? 'relative after:absolute after:bg-[#ED1B24] after:text-white after:w-[20px] after:h-[5px] after:rounded after:right-0 after:mx-auto after:left-0 after:bottom-[-8px] text-[#ED1B24] px-3 py-2 '
              : isPending
                ? 'pending'
                : 'px-3'
          }
  ...
  return (
    <div className="shadow bg-white  fixed top-0 w-full z-[100]">
        ...
        <div className="relative flex items-center justify-between font-bold">
          {scrollNav ? (
            <ul className="md:flex block items-center">
              ...
              <li className="lg:hidden md:block block w-[90px]">
                <img
          ...
          <div className="lg:flex md:hidden justify-between items-center gap-5">
            <ul className="items-center hidden font-[700] lg:flex">
              <div className={scrollNav ? 'hidden' : 'flex items-center'}>
                {menuItem}
              </div>
              ...
              <div
                className={
                  scrollNav
                    ? 'flex items-center absolute bg-[#FA111B] bottom-[-40px] left-0 right-0 mx-auto w-[70px]  h-[70px] rounded-full justify-center'
                    : 'hidden'
                }
              >
                <Link to="">
              ...
              <li>
                <NavLink to="/cart" className="py-2 relative">
                  ...
                  <div className="h-4 w-4 bg-[#FE0651] rounded-full flex justify-center items-center -top-[8px] absolute -right-[6px]">
                    <p className="text-white mt-[2px]  ">{addToCart.length}</p>
                  </div>
                </NavLink>
              </li>
            </ul>
            {user ? (
              <Link className="hidden sm:block" to="/courses">
                <button className="px-[32px] my-btn py-[9px] bg-[#ED1B24] rounded-md text-white shadow-lg">
                  Enroll
                </button>
              </Link>
            ) : (
