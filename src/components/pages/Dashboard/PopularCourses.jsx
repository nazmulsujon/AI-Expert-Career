...
const PopularCourses = () => {
    ...
    return (
        <div className="mt-[30px]">
            ...
            <div className="grid md:grid-cols-2  gap-5 mt-[17px]">
                {aboutCard.map(({ id, img, headline, info, price }) => (
                    ...
                    >
                        ...
                        <div className="">
                            <h3 className="text-[20px] font-bold mb-[20px]">{headline}</h3>
                            <p className="mb-[40px]">{info}</p>
                            <div className="flex justify-between items-center ">
                                <button className="px-[32px] py-[8px] bg-[#ED1B24] rounded-md text-white shadow-lg">
                                    Buy
                                </button>
