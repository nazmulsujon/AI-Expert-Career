...
const JobOpportunity = () => {
  ...
  return (
    <div className=" md:mt-[80px] mt-[70px] px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="">
        <h1 className="mt-[32px] lg:mt-[60px] text-left-[35px] font-[700] text-center">Job Opportunity</h1>
      ...
      <div className="my-[32px] lg:my-[60px] grid md:grid-cols-2 lg:grid-cols-3 gap-5 ">
        {jobs.map(({ id, img, headline, job_post, address, description, uploadTime }) => (
          <div
            key={id}
            className="px-[17px] py-[15px] shadow-lg hover:shadow-lg rounded-[10px] bg-[#ed1b240d] w-full h-[400px]  lg:w-[358px] lg:h-[420px]"
          >
            <div className="flex items-center">
              <img className="w-[81px] h-[81px] rounded-full mr-5" src={img} alt="courseImg" />
              <div>
            ...
            <div className="mt-8 mb-5 ps-2 pr-8">
              ...
              <p className="font-semibold mb-[20px] text-[16px]">
                ...
                <button onClick={() => redirectIndibidualJob(id)} className="font-bold">
                  See More
                </button>
              </p>
            </div>
      ...
      <div class="pagination my-[32px] lg:my-[60px] text-center font-semibold">
        ...
        <Link className="w-[10px] h-[20px] rounded-lg bg-[#D9D9D9] text-black ms-2 me-2 mx-auto p-4" href="#">
          1
        </Link>
        <Link className="w-[10px] h-[20px] rounded-lg bg-[#D9D9D9] text-black me-2 mx-auto p-4" href="#">
          2
        </Link>
        <Link className="w-[10px] h-[20px] rounded-lg bg-[#D9D9D9] text-black me-2 mx-auto p-4" href="#">
          3
