  ...
  return (
    <div className="bg-[#F3F2FF]">
      <div className="py-2  px-4 mx-auto max-w-full md:max-w-full lg:max-w-screen-xl xl:max-w-screen-xl 2xl:max-w-screen-2xl md:px-24 lg:px-20 2xl:px-8 pt-20">
        ...
        <div className="grid grid-cols-12 lg:gap-x-[117px] mt-12">
          <div className="col-span-12 lg:col-span-8 border-t border-black">
            <AboutSection />
          </div>
          <div className="col-span-12 lg:col-span-4 border-t border-black">
            <Expertise />
          </div>
        </div>
      </div>
