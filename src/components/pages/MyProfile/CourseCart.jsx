        ...
        <div className='flex '>
            ...
            <div className='md:space-y-3 space-y-1'>
                ...
                <div className="w-full bg-[#D9D9D9] rounded-full h-4 dark:bg-gray-700 relative mb-1">
                    ...
                    <p className='absolute -top-[4px] right-2'>{progressPercentage < 100 ? <span className='text-[10px] text-black/80 font-bold'>{`${progressPercentage}% Complete`}</span> : <span className='text-[10px] text-white font-bold'>Completed</span>}</p>
                </div>
