    ...
    <div>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 py-5">
          ...
          <EventTitle
            title={language == "bn" ? "ইভেন্ট নিয়ে কিছু কথা" : "Event FAQ"}
          />
        </div>
        <a href="#idStart">
          <Link
          ...
          >
            ...
            {language == "bn" ? "টিকেট কিনুন" : "Buy a ticket"}
          </Link>
        </a>
      </div>
      <main className="grid grid-cols-3 gap-3 n-group">
        ...
        >
          {event?.eventFaq?.map((itm) => (
            ...
            >
              <img
                src="https://i.ibb.co/zbBRGF2/active-Faq.png"
                className="w-[35px]"
              />
              {itm.title}
            </li>
          ...
          <div className="bg-white p-8 m">
            ...
            <ul className="mt-6">
              {faqData.tags.map((itm, index) => (
                ...
                >
                  <img
                    src="https://i.ibb.co/RSVxNQN/check.png"
